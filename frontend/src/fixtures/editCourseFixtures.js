const editCourseFixtures = {
  oneCourse: [
    {
      ...
      description:
        "Principles of critical reading, thinking, and writing in the university. Wr iting focuses on analysis of academic discourse and development of rhetoric al strategies. Completion with a grade of C or better meets Entry Level Wri ting Requirement.",
  ...
  twoCourses: [
    ...
    },
    {
      ...
      description:
        "Group experiential learning in a sociological setting as directed by facult y.",
      classSections: [[Object]],
      generalEducation: [],
      finalExam: null,
      id: 75,
  ...
  psIdCall: [
    {
      ...
      user: {
        ...
        pictureUrl:
          "https://lh3.googleusercontent.com/a/ACg8ocK6Q8G3q4upKsbc-xkOoyHZ719H3otbwG8yTKe1RRDZyw=s96-c",
